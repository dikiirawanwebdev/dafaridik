...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Dashboard'); ?> - Admin DAFARIDIK</title>
    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <aside id="sidebar" class="fixed inset-y-0 left-0 z-40 w-64 -translate-x-full md:translate-x-0 transition-transform duration-300 ease-in-out" style="background: linear-gradient(180deg, #124170 0%, #215B63 100%);">
            <div class="flex items-center justify-between px-6 py-5 border-b border-white/10">
                <a href="<?php echo e(route('admin.dashboard')); ?>" class="text-xl font-extrabold tracking-tight text-white">
            ...
            <nav class="px-4 py-6 space-y-1">
                <a href="<?php echo e(route('admin.dashboard')); ?>" class="flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 <?php if(request()->routeIs('admin.dashboard')): ?> text-white bg-white/15 <?php else: ?> text-white/70 hover:text-white hover:bg-white/10 <?php endif; ?>">
                    <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/>
                    </svg>
                    Dashboard
                </a>
                <a href="<?php echo e(route('admin.products.index')); ?>" class="flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 <?php if(request()->routeIs('admin.products.*')): ?> text-white bg-white/15 <?php else: ?> text-white/70 hover:text-white hover:bg-white/10 <?php endif; ?>">
                    <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"/>
                    </svg>
                    Produk
                </a>
                <a href="<?php echo e(route('admin.categories.index')); ?>" class="flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 <?php if(request()->routeIs('admin.categories.*')): ?> text-white bg-white/15 <?php else: ?> text-white/70 hover:text-white hover:bg-white/10 <?php endif; ?>">
                    <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <header class="bg-white border-b border-gray-200 sticky top-0 z-20 animate-slide-down">
                <div class="flex items-center justify-between px-4 md:px-6 py-3">
                    ...
                    <div class="flex items-center gap-4 ml-auto">
                        <a href="<?php echo e(route('home')); ?>" class="text-sm text-gray-500 hover:text-[#124170] transition-colors flex items-center gap-1" target="_blank">
                ...
                <?php if(session('success')): ?>
                    <div id="toast-success" class="fixed top-4 right-4 z-[60] max-w-sm">
                        <div class="bg-white shadow-lg rounded-xl px-5 py-4 border-l-4 flex items-start gap-3 animate-slide-right" style="border-left-color: #67C090;">
                            ...
                            <div class="flex-1">
                                <p class="text-sm font-medium text-gray-800"><?php echo e(session('success')); ?></p>
                            </div>
                ...
                <?php if(session('error')): ?>
                    <div id="toast-error" class="fixed top-4 right-4 z-[60] max-w-sm">
                        <div class="bg-white shadow-lg rounded-xl px-5 py-4 border-l-4 flex items-start gap-3 animate-slide-right" style="border-left-color: #EF4444;">
                            ...
                            <div class="flex-1">
                                <p class="text-sm font-medium text-gray-800"><?php echo e(session('error')); ?></p>
                            </div>
...
<?php /**PATH C:\laragon\www\DIKSHOP\resources\views/admin/layouts/app.blade.php ENDPATH**/ ?>