                ...
                <form method="POST" action="{{ route('admin.login') }}" class="space-y-5">
                    ...
                    <div>
                        ...
                        <input type="email" name="email" id="email" value="{{ old('email') }}"
                               class="w-full px-4 py-2.5 rounded-xl border @error('email') border-red-300 @else border-gray-200 @enderror focus:ring-2 focus:ring-[#67C090] focus:border-[#67C090] outline-none transition-all text-sm"
                    ...
                    <div>
                        ...
                        <input type="password" name="password" id="password"
                               class="w-full px-4 py-2.5 rounded-xl border @error('password') border-red-300 @else border-gray-200 @enderror focus:ring-2 focus:ring-[#67C090] focus:border-[#67C090] outline-none transition-all text-sm"
