                    ...
                    @forelse($categories as $category)
                        <tr class="hover:bg-gray-50 transition-colors duration-200">
                            ...
                            <td class="px-4 md:px-6 py-4 hidden sm:table-cell">
                                <p class="text-gray-500 max-w-xs truncate">{{ $category->description ?? '-' }}</p>
                            </td>
                            <td class="px-4 md:px-6 py-4">
                                <span class="font-semibold" style="color: #215B63;">{{ $category->products_count }}</span>
                            </td>
                            <td class="px-4 md:px-6 py-4 text-right">
                                <div class="flex items-center justify-end gap-2">
                                    ...
                                    <form action="{{ route('admin.categories.destroy', $category) }}" method="POST" class="delete-form inline">
                                        @csrf @method('DELETE')
