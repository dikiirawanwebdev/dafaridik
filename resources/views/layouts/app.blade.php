...
<head>
    ...
    <title>@yield('title', 'DAFARIDIK') - Toko Pakaian Pria</title>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16">
                ...
                <div class="hidden md:flex items-center space-x-8">
                    <a href="{{ route('home') }}" class="font-medium text-sm transition-all duration-200 hover:scale-105" style="color: #215B63;">
                        Beranda
                    </a>
                    <a href="{{ route('products.index') }}" class="font-medium text-sm transition-all duration-200 hover:scale-105" style="color: #215B63;">
                        Produk
                    </a>
                    <a href="{{ route('cart.index') }}" class="relative flex items-center space-x-1 font-medium text-sm transition-all duration-200 hover:scale-105" style="color: #215B63;">
            ...
            <div id="mobile-menu" class="hidden md:hidden pb-4 space-y-2">
                <a href="{{ route('home') }}" class="block px-3 py-2 rounded-lg font-medium text-sm transition-colors duration-200 hover:bg-[#AAFFC7]/50" style="color: #215B63;">
                    Beranda
                </a>
                <a href="{{ route('products.index') }}" class="block px-3 py-2 rounded-lg font-medium text-sm transition-colors duration-200 hover:bg-[#AAFFC7]/50" style="color: #215B63;">
                    Produk
                </a>
            </div>
        </div>
    ...
    <footer class="text-white" style="background-color: #215B63;">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-sm">
                        <li><a href="{{ route('home') }}" class="opacity-80 hover:opacity-100 transition-opacity">Beranda</a></li>
                        <li><a href="{{ route('products.index') }}" class="opacity-80 hover:opacity-100 transition-opacity">Produk</a></li>
                        <li><a href="{{ route('cart.index') }}" class="opacity-80 hover:opacity-100 transition-opacity">Keranjang</a></li>
                    </ul>
                </div>
                <div>
            ...
            <div class="mt-8 pt-8 border-t border-white/20 text-center text-sm opacity-60">
                &copy; {{ date('Y') }} DAFARIDIK. All rights reserved.
            </div>
        </div>
    </footer>
