<?php $__env->startSection('title', 'DAFARIDIK - Toko Pakaian Pria'); ?>
        ...
        <div class="grid md:grid-cols-2 gap-12 items-center">
            <div class="animate-fade-in">
                ...
                <div class="flex flex-wrap gap-4">
                    <a href="<?php echo e(route('products.index')); ?>" class="inline-flex items-center px-8 py-3 rounded-xl font-semibold text-sm transition-all duration-300 hover:scale-105 hover:shadow-lg" style="background-color: #124170; color: white;">
                        Belanja Sekarang
...
<section class="py-16 md:py-20" style="background-color: #67C090/10;">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <a href="<?php echo e(route('products.index', ['category' => $category->slug])); ?>" class="group relative bg-white rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-2 overflow-hidden animate-on-scroll">
                ...
                <div class="p-4 text-center">
                    <h3 class="font-semibold text-gray-800 group-hover:text-[#124170] transition-colors"><?php echo e($category->name); ?></h3>
                    <p class="text-xs text-gray-500 mt-1"><?php echo e($category->products_count ?? $category->products()->count()); ?> Produk</p>
                </div>
            </a>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="relative rounded-3xl overflow-hidden animate-on-scroll" style="background: linear-gradient(135deg, #124170 0%, #215B63 50%, #67C090 100%);">
            ...
            <div class="relative z-10 px-8 py-12 md:px-16 md:py-20 text-center">
                ...
                <a href="<?php echo e(route('products.index')); ?>" class="inline-flex items-center px-8 py-3 rounded-xl font-semibold text-sm transition-all duration-300 hover:scale-105 hover:shadow-lg" style="background-color: #AAFFC7; color: #124170;">
                    Belanja Sekarang
                    <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6"/>
                    </svg>
...
<section class="py-16 md:py-20" style="background-color: #124170/5;">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col md:flex-row md:items-end justify-between mb-12 animate-on-scroll">
            ...
            <a href="<?php echo e(route('products.index')); ?>" class="mt-4 md:mt-0 inline-flex items-center font-semibold text-sm transition-all duration-300 hover:gap-2" style="color: #124170;">
                Lihat Semua
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\DIKSHOP\resources\views/home/index.blade.php ENDPATH**/ ?>