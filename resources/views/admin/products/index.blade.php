...
@section('content')
    <div data-reveal="fade-up">
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <a href="{{ route('admin.products.create') }}" class="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-sm font-semibold text-white transition-all duration-300 hover:scale-[1.02] active:scale-95 hover:shadow-lg" style="background-color: #124170;">
                    ...
                    @forelse($products as $product)
                        <tr class="hover:bg-gray-50 transition-colors duration-200">
                            <td class="px-4 md:px-6 py-4">
                                <img src="{{ $product->image }}" alt="{{ $product->name }}" class="w-12 h-12 md:w-14 md:h-14 rounded-xl object-cover ring-1 ring-gray-200" loading="lazy">
                            </td>
                            <td class="px-4 md:px-6 py-4">
                            ...
                            <td class="px-4 md:px-6 py-4">
                                <span class="font-semibold" style="color: #215B63;">{{ $product->formatted_price }}</span>
                            </td>
                            ...
                            <td class="px-4 md:px-6 py-4 text-right">
                                <div class="flex items-center justify-end gap-2">
                                    <a href="{{ route('admin.products.edit', $product) }}" class="p-2 rounded-lg hover:bg-gray-100 transition-colors group" title="Edit">
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="px-6 py-16 text-center">
                                ...
                                <a href="{{ route('admin.products.create') }}" class="inline-block mt-3 text-sm font-semibold" style="color: #124170;">Tambah produk pertama</a>
                            </td>
                        </tr>
                    @endforelse
                </tbody>
